...
func DefaultResponseDTO() cards.ResponseDTO {
	return cards.ResponseDTO{
		Data: []cards.CardDTO{
			{
	...
	return cards.Card{
		...
		Prices: cards.Printings{
			...
			"Unlimited Holofoil": cards.Conditions{
				NearMint: &cards.Prices{
					Market:      ftop(1923.19),
					MinPrice30d: ftop(1700),
					MaxPrice30d: ftop(1923.19),
					LastUpdated: tptr(time.Unix(1758706033, 0).UTC()),
				},
				LightlyPlayed: &cards.Prices{
					Market:      ftop(1299),
					MinPrice30d: ftop(1299),
					MaxPrice30d: ftop(1299),
					LastUpdated: tptr(time.Unix(1758706033, 0).UTC()),
				},
				ModeratelyPlayed: &cards.Prices{
					Market:      ftop(764.78),
					MinPrice30d: ftop(761.02),
					MaxPrice30d: ftop(813.73),
					LastUpdated: tptr(time.Unix(1758706033, 0).UTC()),
				},
				HeavilyPlayed: &cards.Prices{
					Market:      ftop(645.05),
					MinPrice30d: ftop(642.95),
					MaxPrice30d: ftop(649),
					LastUpdated: tptr(time.Unix(1758706033, 0).UTC()),
				},
				Damaged: &cards.Prices{
					Market:      ftop(524.96),
					MinPrice30d: ftop(523.77),
					MaxPrice30d: ftop(533.29),
					LastUpdated: tptr(time.Unix(1758706033, 0).UTC()),
				},
			},
		},
